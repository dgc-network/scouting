...
if (!class_exists('line_login_api')) {
    class line_login_api {
        ...
        function line_login_register_settings() {
            ...
            add_settings_field(
                'line-login-token-option',
                'Line login Token',
                array( $this, 'line_login_token_option_callback' ),
                'web-service-settings',
                'line-login-section-settings'
            );
            register_setting('web-service-settings', 'line-login-token-option');
/*
            add_settings_field(
...
*/            
        ...
        function line_login_token_option_callback() {
            $value = get_option('line_login_token_option');
            echo '<input type="text" id="line-login-token-option" name="line_login_token_option" style="width:100%;" value="' . esc_attr($value) . '" />';
        }
